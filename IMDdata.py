...
def get_weekly_filename():
    ...
    return f"weather_logs/india_weather_{year}_week{week:02d}.csv"
...
def fetch_and_log():
        ...
        def new_ehi(row):
            ...
            try:
                ...
                if temp_c is not None and rh_percent is not None:
                    ...
                    zone_map = {1: "Zone 1", 2: "Zone 2", 4: "Zone 4", 5: "Zone 5", 6: "Zone 6"}
                    zone = zone_map.get(zone_num, "Zone 2 or 3")
                    return pd.Series([ehi, zone])
                else:
                    return pd.Series([None, None])
            except:
    ...
    try:
        ...
        with open("weather_logs/latest_alerts.json", 'w') as f:
    ...
    try:
        ...
        history_file = "weather_logs/alerts_24h.json"
    ...
    try:
        ...
        stats_file = "weather_logs/summer_stats.json"
